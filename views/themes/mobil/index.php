...
<body class="goto-here">
                    ...
                    <div class="row d-flex">
                        ...
                        <div class="col-md pr-4 d-flex topper align-items-center">
                            ...
                            <a href="mailto:<?=settings('company_profile','email');?>"><span
                                    class="text">recar@gmail.com</span></a>
                        </div>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
        <div class="container">
            <a class="navbar-brand" href="#">ReCar</a>
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdown04">
                            <a class="dropdown-item" href="<?=base_url('imange/bg4');?>">Profil</a>
            ...
            <div class="row mb-5">
                <div class="col-md">
                    <div class="ftco-footer-widget mb-4">
                        <h2 class="ftco-heading-2"><a href="#">ReCar</a></h2>
                        <p>Produk resmi dan bergaransi dari ReCar</p>
                        ...
                        <div class="block-23 mb-3">
                            <ul>
                                <li><span class="icon icon-map-marker"></span><span
                                        class="text">Jl. Ring Road Utara, Ngringin, Condongcatur, Kec. Depok, Kabupaten Sleman, Daerah Istimewa Yogyakarta<br>                                        
                                        Kode Pos
                                        55281</span></li>

                                <li><a href="tel:<?=settings('company_profile','phone');?>"><span
                                            class="icon icon-phone"></span><span
                                            class="text">081382055381</span></a></li>
                                <li><a href="mailto:<?=settings('company_profile','email');?>"><span
                                            class="icon icon-envelope"></span><span
                                            class="text">recar@gmail.com</span></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
