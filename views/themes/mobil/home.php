...
<section id="home-section" class="hero">
    ...
    <div class="slider-item" style="background-image: url(<?=base_url().'views/themes/mobil/images/bmw.jpg'; ?>);">
        <div class="overlay"></div>
      <div class="container">
        <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">
          <div class="col-md-12 ftco-animate text-center">
            <h1 class="mb-2">ReCar</h1>
            <h2 class="subheading mb-4">Mobil terbaik dikelasnya</h2>
    ...
    <div class="slider-item" style="background-image: url(<?=base_url().'views/themes/mobil/images/bmw2.jpg'; ?>);">
        <div class="overlay"></div>
      <div class="container">
        <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">
          <div class="col-sm-12 ftco-animate text-center">
            <h1 class="mb-2">Mobil dengan kualitas terbaik</h1>
            <h2 class="subheading mb-4">ReCar</h2>
            <p><a href="#products" class="btn btn-danger">Belanja Sekarang</a></p>
          </div>
        </div>
      </div>
    </div>
    <div class="slider-item" style="background-image: url(<?=base_url().'views/themes/mobil/images/bmw3.jpg'; ?>);">
        <div class="overlay"></div>
      <div class="container">
        <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">
          <div class="col-sm-12 ftco-animate text-center">
                ...
                <div class="row">
                    <div class="col-md-4 align-items-stretch d-flex">
                        <div class="category-wrap-2 ftco-animate img align-self-stretch d-flex"
                            style="background-image: url(<?=base_url().'views/themes/'.theme_active().'/';?>images/Palsu2.jpg);">
...
<section class="ftco-section" style="margin-top:-65px;">
    ...
    <div class="container">
        <div class="row justify-content-center mb-3 pb-3">
            <div class="col-md-12 heading-section text-center ftco-animate">
                <a href="<?=base_url('public/product');?>"><span class="subheading">-- LIHAT SEMUA PRODUK KAMI --</span></a>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        <div class="row justify-content-center mb-5 pb-3">
            <div class="col-md-7 heading-section ftco-animate text-center">
                ...
                <p>Berikut ini testimoni pelanggan yang sudah berbelanja di ReCar.</p>
            </div>
        </div>
