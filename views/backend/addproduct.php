                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control harga" placeholder="Stok Produk" name="stok"
                            value="<?=isset($edata) && is_array($edata) ? $edata['stok'] : set_value('stok');?>" <?=$edit_stok;?>>
                    </div>
                </div>
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <textarea id="editor1" name="keterangan" rows="10"
                            cols="80"><?=isset($edata) && is_array($edata) ? $edata['keterangan'] : set_value('keterangan');?></textarea>
                    </div>
                </div>
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <input type="file" class="form-control" name="image"
                            value="<?=isset($edata) && is_array($edata) ? $edata['product_image'] : set_value('image');?>">
